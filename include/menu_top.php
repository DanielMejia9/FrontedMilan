  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="../modulo.php"><img src="../images/logo.png" width='120' '/></a>
      </div>
                        ...
                        <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Historial<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                              <li class=""><a href="/historial/historial-servicios.php">Historial de Servicios<span class="sr-only">(current)</span></a></li>
                              <li class=""><a href="/historial/historial-redes-sociales.php">Historial Redes Sociales<span class="sr-only">(current)</span></a></li>
                            </ul> 
                        </li>   
                        <li class=""></li>
